...
public abstract class ParserRule implements ParserRuleFunctions, MCScriptObject {
	...
	/**
	 * <p> This variable contains the actual Parsable. It will be automatically updated
	 * before the {@link ParserRule#apply()} function is executed, and all edits will be
	 * automatically applied to all other ParserRules that are registred in the {@link ParserRuleManager}</p>
	 * @see Parsable
	 */
	protected Parsable parsable;
	
	/**
	 * <p>This variable contains the actual ParsedObject. It will be automatically updated
	 * before the {@link ParserRule#apply()} function is executed, and all edits will be
	 * automatically applied to all other ParserRules that are registred in the {@link ParserRuleManager}</p>
	 * @see ParsedObject
	 */
	...
	/**
	 * @see String
	 * <p>This variable contains the file that is parsed at the moment</p>  
	 */
